export default {
    ...
    `,
      data: {
        data() {
          return {
            fileList: [
              {name: '1.jpg'},{name: '22222222222222222222222222222222222.png'}
            ]
          };
        },
        methods: {
  ...
  <template>
    ...
    { title: '手动上传（插槽自定义）',
     ...
     <dj-button slot="handupload" @click="handUpload" type="success" :disabled="fileList.length==0">上传到服务器</dj-button>
      </dj-upload>
    `,
      data: {
        data() {
